		...
		callbacks: {
			...
			title: function(tooltipItems, data) {
				...
				if (tooltipItems.length > 0) {
					...
					var tmp = item.datasetIndex;
					var tmporder = item.index;
					var sentence = data.datasets[tmp].sentence[tmporder];
					if (item.xLabel) {
						title =  sentence;
...
module.exports = {
	 ...
	 * the plugin, which one will be re-exposed in the chart_js file.
