var Menu = (function() {
	...
	var $container = $( '#rm-container' ),						
		...
		viewDetails = function( recipe ) {
			...
			var $modal = $( '<div class="rm-modal"><iframe width="370" height="420" src="https://www.youtube.com/embed/tMbxviif0ek"> </iframe><a href="' + url + '">Go to github</a><span class="rm-close-modal">x</span></div>' );
