...
!function (e) {
    e.fn.hover3d = function (t) {
        ...
        return this.each(function () {
            function t(e) {
                ...
                switch (choice[0]) {
                    case 'I':
                        ...
                        break;
                    case 'C':
                        speak('Creative Coding');
                        break;
                    case 'H':
                        speak("Human Computer Interaction Research");
                        break;
                    case 'P':{
                        switch (choice[2]){
                            case "l":
                                speak("Politics of code blog");
                                break;
                            case "o":
                                speak("Photo gallery");
                                break;
                            case "e":
                                speak("Poetry Collection");
                                break;
                        }
                        break;
                    }
                    case "F":
                        speak("Future Reality");
                        break;
                    case "I":
                        speak("iGEM");
                        break;
                ...
                // if(i.hasClass('gif')){
                // var src = i.attr("src");
                // i.attr("src", src.replace(/\.png/i, ".gif"));
                // console.log(i.context.id);
                // }

            }

            function s(e) {
                var t = i.innerWidth(), s = i.innerHeight(), n = Math.round(e.pageX - i.offset().left),
            ...
            function n() {
                //choice = ["Welcome!","你好 nihao!","Marhaba!مرحبا","¿Cómo va?"][Math.floor(Math.random()*4)];
                choice = "out";
                // if(i.hasClass('gif')) {
                //     var src = i.attr("src");
                //     i.attr("src", src.replace(/\.gif$/i, ".png"));
                // }
            ...
            var o = e(this), i = o.find(r.selector);
